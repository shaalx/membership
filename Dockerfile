...
RUN mkdir -p $GOPATH/src/github.com/shaalx/membership;cd $GOPATH/src/github.com/shaalx/membership;git init;git remote add origin https://github.com/shaalx/membership;git fetch origin devm:devm;git checkout devm;go build -o membership;cp membership $GOPATH/bin/
EXPOSE 80
